...
const UserCard = ({ name, email, phone, roll, dept, batch , id }) => {
  ...
  useEffect(() => {
    axios
      .get(`https://codebird-admin-server.vercel.app/api/user/https://codebird-admin-server.vercel.app`, {
  ...
  const handleUpdate = async ()=>{
    try {
      const res = await axios.patch(`https://codebird-admin-server.vercel.app/api/update/https://codebird-admin-server.vercel.app`,update, {
        withCredentials: true,
      });
      if (res) {
  ...
  const handel = async ()=>{
    try {
      const res = await axios.delete(`https://codebird-admin-server.vercel.app/api/users/https://codebird-admin-server.vercel.app`, {
        withCredentials: true,
      });
      if (res) {
