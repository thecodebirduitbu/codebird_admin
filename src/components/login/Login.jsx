...
const Login = () => {
  ...
  const loginSubmit = async () => {
    if (!lformData.email || !lformData.password) {
      ...
      console.log(lformData);
      try {
        await axios.post(`https://thecodebird-admin-server.vercel.app/api/login`, lformData, {
  ...
  const registerSubmit = async () => {
    if (
      ...
      try {
        await axios.post(`https://thecodebird-admin-server.vercel.app/api/register`, rformData, {
          withCredentials: true,
        });
